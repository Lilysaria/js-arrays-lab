...
const deleteAdd = foods.splice(1, 1, "sushi","cupcake");
...
/*
Exercise 9:
  - Assign to a variable named allFoods the result of joining the 
  strings in the foods array such that the result is the
   following single string:
...
/*
Exercise 15:
  - Given the above numArrays array, use nested forEach methods
  to sum up all the numbers contained within numArrays and assign to a
   variable named total.
  - Hint: Be sure to declare and initialize the total variable before the iterations.
*/

// Complete Exercise 15 below...
//https://stackoverflow.com/questions/64437674/how-to-nest-a-foreach-in-a-foreach-to-get-sum-for-javascript
total = 0;
